...
public class FragmentTwo extends Fragment {
    ...
    public void updateFragmentTwo(Car car) {
        System.out.println("FragmentTwo: " + car.getModel());
        System.out.println("FragmentTwo: " + car.getType());
        System.out.println("FragmentTwo: " + car.getYear());

        adapter.addItem(car, adapter.getItemCount());
